...
namespace Store.AccessData.Interfaces
{
    ...
    {
        public Task<int> CreateAsync(int customerNumber, DateTime docDate, string docStatus, string methodPayment);
        ...
        public Task ChangePaymentMethodAsync(int docNum, string paymentMethod);
